  ...
  fbq('track', 'AddToWishlist');
	...
	<div class="t-header clearfix">
		<div class="container-fluid">
			<div class="full-width">
				<a href="http://hedgeconnect.co"><div class="logo">
					<img src="http://hedgeconnect.co/logo.png" alt="image">
				</div></a>
			</div>
		</div>
	</div>
	<section class="thanks-sec">
		<div class="thanks-msg text-center">
			<h1><b>THANK YOU</b></h1>
			<div class="m-top-30">
				<img src="http://hedgeconnect.co/checked.png" alt="image">
			</div>
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6">
            <ul class="list-unstyled text-right socail-network">
              ...
              <h5><a href="downloads/Privacy_Policy.pdf" target="_blank">Privacy Policy</a> <br>
                <a href="downloads/Terms_and_Conditions.pdf" target="_blank">Terms and Conditions</a> </h5>
            </ul>
          </div>
        </div>
      </div>

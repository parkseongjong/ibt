...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Token Price Management</li>
        </ol>
    </section>
				...
				<div class="w3agile-validation w3ls-validation mt20">
                    <div class="agile-validation agile_info_shadow">
                        <div class="validation-grids widget-shadow  " data-example-id="basic-forms">
                            <div class="input-info">
                                <h3 class="w3_inner_tittle two">Add/Edit Token :</h3>
                            </div>
				  ...
				  ?>
                                    ...
                                    <div class="col-md-3 form-group valid-form">
										...
										<input type="hidden" id="landing_program_id" value="" name="id"/>
                                         <?php  echo $this->Form->input('start_range',array('class' => 'form-control input-style required','label' =>false,"type"=>"text","id"=>"total_token","required"=>true));?>
                                        
                                    </div>
                                    <div class="col-md-3 form-group valid-form">
                                        End Range:
                                        <?php  echo $this->Form->input('end_range',array('class' => 'form-control input-style required','label' =>false,"type"=>"text","id"=>"sold_token","required"=>true));?>
                                    </div>

									 <div class="col-md-3 form-group valid-form">
                                        Price in USD:
                                        <?php  echo $this->Form->input('price',array('class' => 'form-control input-style required','label' =>false,"type"=>"text","id"=>"token_value","required"=>true));?>
                                    </div>
				  ...
				  <div class="w3agile-validation w3ls-validation mt20">
                    <div class="agile-validation agile_info_shadow">
                        <div class="validation-grids widget-shadow  " data-example-id="basic-forms">
                            <div class="input-info">
                                <h3 class="w3_inner_tittle two">List of Token:</h3>
                            </div>
							...
							<tr style="text-align:center;" class="<?=$class?>" id="user_row_<?= $data['id']; ?>">
								<td > <?=$count?></td>
								<td class="total_token_<?= $data['id']; ?>" ><?=$data['start_range'];?> </td>
								<td class="sold_token_<?= $data['id']; ?>" ><?=$data['end_range'];?> </td>
								
								<td class="token_value_<?= $data['id']; ?>">$ <?php echo $data['price'];?> </td>
								<td class="btc_value_<?= $data['id']; ?>"><?php echo date("d-m-Y H:i:s",strtotime($data['created']));?> </td>
	...
	function delete_section(id){
		bootbox.confirm("Are you sure?", function(result) {
			if(result == true){
				jQuery.ajax({ 
					//url: 'delete',
					url: '<?php echo $this->Url->build(['controller'=>'Token','action'=>'deleteProgram']); ?>',
					data: {'id':id},
					type: 'POST',

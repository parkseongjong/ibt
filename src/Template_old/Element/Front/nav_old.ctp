...
<!--<div  class="alert alert-danger">Exchange is under maintenance.
    ...
    <div class="navbar-header"> <a href="<?php echo $this->Url->build(['controller'=>'pages','action'=>'dashboard']) ?>" class="navbar-brand">
      <div class="brand-logo"><i class="fa fa-bitcoin"></i> livecrypto</div>
	  ...
	  <li>
		<ul class="list-inline customcss">
			<li><strong>2FA</strong></li>
				...
				<li><label class="switch" style="    margin-top: 4px;">
	...
	<!---Second verification slider end--->
        ...
        <li class="dropdown"> <a href="javascript:void(0);" data-toggle="dropdown" data-play="bounceIn" class="dropdown-toggle"> <em class="fa fa-user"></em> </a>
          <ul class="dropdown-menu">
            <li><a href="<?php echo $this->Url->build(['controller'=>'users','action'=>'profile']) ?>">Profile</a> </li>
            <li><a href="<?php echo $this->Url->build(['controller'=>'pages','action'=>'mywallet']); ?>">My Wallet</a> </li>

<aside class="main-sidebar"> 
  ...
  <section class="sidebar"> 
	...
	<li class="treeview"> <a href="#"> <i class="fa fa-wrench" aria-hidden="true"></i> <span>BTC Wallet</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
		<ul class="treeview-menu">
		  <li><a target="_blank" href="#"><i class="fa fa-user" aria-hidden="true"></i> Deposit   </a></li>
		  <li><a href="<?php echo $this->Url->build(['controller'=>'users','action'=>'profile']);  ?>"><i class="fa fa-user" aria-hidden="true"></i> Withdrawl</a></li>
		  
		</ul>
	</li>	
	
	<li> <a target="_blank" href="#"> <i class="fa fa-dashboard"></i> <span>Lending </span> </a> </li>

					  ...
					  <div class="col-lg-10">
                       <div class="inner_content_w3_agile_info">
						  <span class="referral-part">
							...
							<a onclick="copyToClipboard();" class="field-icon field-icon-reff" title="Copy your referral link">
							...
							<a onclick="copyToClipboardCode();" class="field-icon field-icon-reff" title="Copy your referral link">

...
<?=$this->Flash->render();?>
	<div class="login-html">
		...
		<div class="login-form">
			  ...
			  <?php  echo $this->Form->create($user,array('url'=>'front/register','class'=>'form-horizontal form-label-left','novalidate','method'=>'post','id'=>'register_form'));?>
			<div class="sign-up-htm">
				...
				<div class="group">
					...
					<input id="pass" name="email" type="text" value="<?php echo $getEmail; ?>" class="input">
				</div>

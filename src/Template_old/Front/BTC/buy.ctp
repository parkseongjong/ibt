<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Buy <small><?=$display_type?></small> </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $this->Url->build(['controller'=>'pages','action'=>'dashboard']);  ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Buy <?=$display_type?></li>
        </ol>
    </section>
        ...
        <div class="inner_content_w3_agile_info">
            <div class="agile-validation agile_info_shadow">
                <div class="validation-grids widget-shadow  " data-example-id="basic-forms">
                    <div class="input-info">
                        <h3 class="w3_inner_tittle two">Buy <?=$display_type?> Coin :</h3>
                       <?= $this->Flash->render(); ?>
                    </div>
            ...
            <div class="clearfix"></div>
              <div class="tab-block mb25" style="position: relative">
                        <div class="tab-content pn-h-small">
                            <div id="main_wallet_panel" class="tab-pane active">
                                <div style="display: flow-root;">
                                    ...
                                    <div class="clearfix"></div>
                                <h3 class="w3_inner_tittle two">Records</h3>
                       ...
                       <?php $this->Paginator->options(array('url' => array('controller' => 'Transactions', 'action' => 'buy_search',$type)));

...
<div class="content-wrapper"> 
  ...
  <section id="content" class="table-layout">
	  <div class="inner_content_w3_agile_info" style="display:none"> 
                   ...
                   <div class="col-md-1 col-sm-1 col-xs-12">
                       <button type="submit" class="btn btn-success">Filter</button>
						...
						<div class="clearfix"></div>
      					...
      					<h3 class="w3_inner_tittle two">In case of any query,please contact at support@hedgeconnect.co</h3>
					<div id="main_wallet_transaction_div" class="mt10 table-responsive">
                                         
						
						   
						<table id="table-two-axis" class="two-axis table"  style="display:none">
                        <thead>
                        <tr>
                            <th>S No.</th>
                            <th>User</th>

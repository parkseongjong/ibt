                            ...
                            <tr class="clickable-row odd" data-href="index.html" role="row">
                              <td class="tableSmallPad sorting_1">
								...
								<a style="color:#fff;" href="<?php echo $this->Url->Build(['controller'=>'exchange','action'=>'index',$getCoinPairSingle['cryptocoin_first']['short_name'],$getCoinPairSingle['cryptocoin_second']['short_name']]); ?>" > 
									<?php echo $getCoinPairSingle['cryptocoin_first']['short_name']."<span style='color:#9e6a04;'>/".$getCoinPairSingle['cryptocoin_second']['short_name']; ?></span> 
								</a>
							   </td>
						...
						<div >
						  ...
						  <div class="m-t-9">
							...
							<input type="submit" class="btn  btn-block buy_ntr" value="Buy <?php echo $secondCoin; ?>">
								<?php } else { ?>
									<a  class="btn  btn-block buy_ntr" href="/front">Login</a>
									<?php } ?>
						  </div>
              ...
              <div class="panel-body">
                <div class="row">
                  <table class="table table-striped table-hover table-condensed table-responsive">
				    ...
				    <div class="col-md-12 col-sm-12" style="background-color:#ccb254;padding:8px;height:310px;">
				 ...
				 0.401210
                  ...
                  <div class="col-md-12 col-sm-12" style="background-color:#ba9050;margin-top:0px;padding:8px;height:320px;">

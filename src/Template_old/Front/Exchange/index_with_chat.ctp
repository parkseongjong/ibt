...
<section>
  ...
  <span class="caret"></span></a>
    ...
    <li><a href="#">BTC markets</a></li>-->
                    ...
                    <div class="dropdown">
                        <a class="dropdown_tog" href="<?php echo $this->Url->build(['prefix'=>'front','controller'=>'exchange' , 'action'=>'index','USD',$secondCoin]);  ?>" type="button">USD markets
  </a>
                        <!--<ul class="dropdown-menu">
    ...
    <li><a href="#">3USD markets</a></li>
                    ...
                    <div class="dropdown">
                        <a class="dropdown_tog" href="<?php echo $this->Url->build(['prefix'=>'front','controller'=>'exchange' , 'action'=>'index','ETH',$secondCoin]);  ?>" type="button">ETH markets
  </a>
                        <!--<ul class="dropdown-menu">
    ...
    <li><a href="#">ETH markets</a></li>
            ...
            <div class="col-lg-3 col-sm-6">
              <div data-toggle="play-animation" data-play="fadeInDown" data-offset="0" data-delay="1500" class="panel widget anim-running anim-done" style="">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="table-responsive" style="overflow-y:auto;max-height:124px;">

                                                <table class="table table-striped table-hover table-condensed table-responsive">
                                                    
                                                    <tbody id="buyAjaxData" class="fixwidth">
                                                        <tr>
                                                            <td width="33%" class="number" colspan='2'><img src="<?php echo $this->request->webroot ?>ajax-loader.gif" /></td>
                                                        </tr>
                                        ...
                                        <div class="col-md-6 col-sm-12">
                                            ...
                                            <div class="table-responsive" style="overflow-y:auto;max-height:124px;">
                                                <table class="table table-striped table-hover table-condensed">
                                                    <tbody id="sellAjaxData" class="fixwidth">
                                                        <tr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                          <div class="panel-heading heading2 bgblue"><h4 class="h4color" style="    display: inline-block; margin: 0;">Market History </h4><a href="javascript:void(0);" data-perform="panel-collapse" data-toggle="tooltip" title="" class="pull-right" data-original-title="Collapse Panel"> <em class="fa fa-minus"></em> </a> </div>
                            <div class="panel-wrapper collapse " aria-expanded="true" style="">
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <table id="market_history_tbl" class="table table-striped table-hover table-condensed" >
											   <thead>
                                                        <tr>
                                                            <th style=" width:29%">Date</th>
                                                            <th style="width:8%">Type</th>
                                                            <th style="width:18%">Price Per
                                                                <?php echo $secondCoin; ?>
                                                            </th>
                                                            <th style="width:25%">
                                                                <?php echo $secondCoin; ?> Amount</th>
            ...
            <div class="col-lg-3">
                        ...
                        <div id="textchat">
                            ...
                            <ul class="chat panel-body">
                                ...
                                if(!empty($get_messages)){ 
                                    $get_messages=array_reverse($get_messages);
                                foreach ($get_messages as $key => $_messages) { ?>
                ...
                <a class="twitter-timeline" data-height="546" href="https://twitter.com/liveCryptoEX">Tweets by liveCrypto_exc</a>
...
var SAMPLE_SERVER_BASE_URL = 'https://livecrypto.exchange';
...
var SESSION_ID = '2_MX40NjIwOTg5Mn5-MTU0NzY0NDIyNjE5MH41VU9sNzV1VFF2QkhrbUhKWHFFL2czQ1V-fg';
var TOKEN = 'T1==';
...
// Send a signal once the user enters data in the form
    ...
    function add_message(){
        ...
        // if(msg!=''){
		// 	$(".chat").append("<p><strong>"+sender+":</strong>"+msg+"</p>");
		// }
            $.ajax({
                        type: "POST",

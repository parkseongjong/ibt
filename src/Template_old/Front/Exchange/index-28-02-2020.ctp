						...
						<div class="pannel panel-body">
						  ...
						  <div class="m-t-9">
							...
							<?php if($currentCoinPairDetail['id']==7) { ?>
								...
								<?php } else { ?>
							<input type="submit" class="btn  btn-block" value="Buy <?php echo $secondCoin; ?>">
								<?php } ?>
						  </div>
						  ...
						  <?php } ?>
							...
							<div class="pannel panel-body">
							  ...
							  <div class="m-t-9">
								...
								<div class="btn  btn-block" >Under Maintenance </div>
								<?php } else { ?>
								<input type="submit" class="btn  btn-block" value="Sell <?php echo $secondCoin; ?>">
								<?php } ?>
							  </div>
      ...
      <div class="row">
            ...
            <div class="col-md-6">
              <div data-toggle="play-animation" data-play="fadeInLeft" data-offset="0" data-delay="1400" class="panel widget anim-running anim-done" style="">
                <div class="panel-body">	
                  ...
                  <p class="text-success" style="float:left;"><i class="fa fa-money"></i> <span id="current_price"> <img src="<?php echo $this->request->webroot ?>ajax-loader.gif" /></span></p>
				  <?php if($firstCoin!="RAM" && $secondCoin!="ADMC" ) { ?>
                 <p class="text-success" style="float:right;"><i class="fa fa-usd"></i> <span id="current_price_usd"> <img src="<?php echo $this->request->webroot ?>ajax-loader.gif" /></span> </p>
				  <?php } ?>
        ...
        <div class="col-lg-4">
                <div class="panel-wrapper collapse in" aria-expanded="true" style="">
				 ...
				 <!--<a class="twitter-timeline" data-height="465" href="https://twitter.com/liveCryptoEX">Tweets by liveCrypto_exc</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>>-->

                    ...
                    <div class="agile-validation agile_info_shadow">
                        <div class="validation-grids widget-shadow" data-example-id="basic-forms">
                            <div class="input-info">
                                <h3 class="w3_inner_tittle two">List of Coin Pair:</h3>
								<a class="btn btn-info" href="<?php echo $this->Url->build(['controller'=>'Coin','action'=>'coinpairAdd']) ?>">Add New</a>
                            </div>
							 <?= $this->Flash->render() ?>
							...
							<tr style="text-align:center;" class="<?=$class?>" id="user_row_<?= $data['id']; ?>">
								...
								<td class=" last">
									<a href="<?php echo $this->Url->build(['controller'=>'Coin','action'=>'coinpairChangestatus',$data['id']]) ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> <?php echo $buttonText; ?> </a>
									
									<a href="<?php echo $this->Url->build(['controller'=>'Coin','action'=>'coinpairEdit',$data['id']]) ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>

        ...
        <div class="inner_content_w3_agile_info">
            <div class="agile-validation agile_info_shadow">
                <div class="validation-grids widget-shadow  " data-example-id="basic-forms">
                    ...
                    <div class="form-body form-body-info">
                        ...
                        <div class="col-md-6 form-group valid-form">
                            Value :
                            <input id="btc" placeholder="0.0 Galaxy" class="form-control" name="amount" required  style="border-bottom:#FF9900 1px solid;border-left:#FF9900 1px solid;border-right:#FF9900 1px solid;border-top:#FF9900 1px solid; border-radius:5px" type="text">
            ...
            <div class="row agile-tables">
                <div class="w3l-table-info agile_info_shadow table-responsive">
                    ...
                    <?php $this->Paginator->options(array('url' => array('controller' => 'Transactions', 'action' => 'send',$type)));

		...
		<div class="clearfix"></div>
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a onclick="export_f('e')" href="javascript:void(0)">Excel</a></li>
                            <li><a onclick="export_f('c')" href="javascript:void(0)">CSV</a></li>
                        </ul>
                    </div>
                    ...
                    <?php $this->Paginator->options(array('url' => array('controller' => 'Reports', 'action' => 'log_search')));

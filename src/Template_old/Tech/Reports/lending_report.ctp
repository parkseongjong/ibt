<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Lending <small>Report</small> </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $this->Url->build(['controller'=>'pages','action'=>'dashboard']);  ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Lending Report</li>
        </ol>
    </section>
    ...
    <section id="content" class="table-layout">
		...
		<div class="clearfix"></div>
                    ...
                    <h3 class="w3_inner_tittle two">Lending Report</h3>
                    <!--<div class="dropdown">
					...
					<img src="<?php echo $this->request->webroot;?>ajax-loader.gif" id="loader" style="display:none;" />

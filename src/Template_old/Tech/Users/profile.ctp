                    ...
                    <div class="validation-grids widget-shadow  " data-example-id="basic-forms">
                        ...
                        <div class="  form-body form-body-info">
							<?php echo $this->Form->create($user,array('enctype'=>'multipart/form-data','class'=>'form-horizontal form-label-left','novalidate','method'=>'post'));?>
                                    ...
                                    <div class="item form-group">
                                     ...
                                     <!--<div class="item form-group">
									   ...
									   <div class="item form-group">
									    ...
									    <div class="item form-group">
										<label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">ID Type  <span class="required">*</span>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										<p>
									    ...
									    <div class="item form-group">
										<label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">ID Number  <span class="required">*</span>
										</label>
									  ...
									  <div class="item form-group">
										<label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">ID Verification  <span class="required">*</span>
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										 <?php  echo $this->Form->input('id_verification_status',array('class' => 'form-control col-md-7 col-xs-12','label' =>false,"type"=>"select",'options'=>[null=>"Not Uploaded",'P'=>"Pending",'N'=>"Cancel",'Y'=>'Verify'])); ?>
										 
										 <?php if(!empty($user->id_document_front)) { ?>
										 <img style="margin:10px;" width="150" src="<?php echo $this->request->webroot; ?>uploads/id_verification/<?php echo $user->id_document_front; ?>" />
										 <?php } ?>
										</div>
									  </div>
									...
									<div class="item form-group">
										<label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">Wallet Address
										</label>
										<div class="col-md-6 col-sm-6 col-xs-12">
										 <?php // echo $this->Form->input('unique_id',array('disabled','class' => 'form-control col-md-7 col-xs-12','label' =>false,"type"=>"text")); ?>
										 <div class="btn btn-success" onClick="wallet_address()">Show Wallet Address</div>
										 <p id="wallet_address" style="display:none;"><?php echo $user->unique_id ?></p>
										</div>
									  </div>

                     ...
                     <div class="form-group">
						...
						<div class="col-md-1 col-sm-1 col-xs-12">
							<button type="submit" class="btn btn-success">Filter</button>
                                ...
                                <h3 class="w3_inner_tittle two">Sell List</h3>
                                ...
                                <div id="main_wallet_transaction_div" class="mt10 table-responsive">
									...
									<table border=1 id="table-two-axis" class="two-axis table">
										...
										<tr class="<?=$class?>">
											...
											<td><?php echo number_format((float)$data['total_sell_spend_amount'],8)?> </td>
											<td><?php echo number_format((float)$data['sell_spend_amount'],8)?> </td>
											<td><?php echo $data['spendcryptocoin']['short_name']?> </td>
											<td><?php echo number_format((float)$data['total_sell_get_amount'],8)?> </td>
											<td><?php echo number_format((float)$data['sell_get_amount'],8)?> </td>
									   ...
									   <?php $this->Paginator->options(array('url' => array('controller' => 'Exchange', 'action' => 'sellListSearch')));

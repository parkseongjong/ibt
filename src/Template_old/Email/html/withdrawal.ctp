...
padding-left: 16px; margin:0px;">Hi ,</h4></td>
          </tr>
          
          <tr align="center">
            <td><p style="padding:0 3%; line-height:25px;    text-align: justify;">New withdrawal request found</p></td>
          </tr>
          
         
        
		  <tr align="center">
            <td><p style="padding:0 3%; line-height:25px;    text-align: justify;">Email : <?php echo $data['user_email']; ?></p></td>
          </tr>
		  
		  <tr align="center">
            <td><p style="padding:0 3%; line-height:25px;    text-align: justify;">Amount : <?php echo $data['amount']; ?></p></td>
          </tr>
		  
		   <tr align="center">
            <td><p style="padding:0 3%; line-height:25px;    text-align: justify;">Wallet Address : <?php echo $data['wallet_address']; ?></p></td>
          </tr>

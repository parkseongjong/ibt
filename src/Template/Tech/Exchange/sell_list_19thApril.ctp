<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?= __('Sell List'); ?></li>
        </ol>
    </section>
<br/>
    <!-- Main content -->
                ...
                <div class="col-lg-12 col-xl-12 center-block ">
                    ...
                    <div class="tab-block mb25" style="position: relative">
                     ...
                     <div class="form-group">
						...
						<div class="col-md-4 col-sm-3 col-xs-12">
							<?php  echo $this->Form->input('email',array('placeholder'=>__('Email'),'class' => 'form-control col-md-7 col-xs-12 has-feedback-left','label' =>false,'type'=>'email','value'=>(!empty($_GET['email']) ? $_GET['email'] : "" ))); ?>
						</div>
						...
						<div class="col-md-1 col-sm-1 col-xs-12">
							<button type="submit" class="btn btn-success"><?= __('Search'); ?></button>
                                        ...
                                        <div class="col-md-4 col-sm-3 col-xs-12">
                                            <?php  echo $this->Form->input('total_amount',array('placeholder'=>__('Total Amount'),'class' => 'form-control col-md-7 col-xs-12 has-feedback-left','label' =>false,'type'=>'text','readonly'=>'readonly','value'=>(!empty($totalSellAmount) ? $totalSellAmount : "" ))); ?>
                                        </div>
                                ...
                                <h3 class="w3_inner_tittle two"><?= __('Sell List'); ?></h3>
                                ...
                                <div id="main_wallet_transaction_div" class="mt10 table-responsive">
									...
									<table border=1 id="table-two-axis" class="two-axis table">
										...
										<tr class="<?=$class?>">
											...
											<td><?php echo number_format((float)$data['total_sell_spend_amount'],4)?> </td>
											<td><?php echo number_format((float)$data['sell_spend_amount'],4)?> </td>
											<td><?php echo $data['spendcryptocoin']['short_name']?> </td>
											<td><?php echo number_format((float)$data['total_sell_get_amount'],4)?> </td>
											<td><?php echo number_format((float)$data['sell_get_amount'],4)?> </td>
											<td><?php echo $data['getcryptocoin']['short_name']?> </td>
											<td> <?php echo number_format((float)$data['per_price'],4); ?></td>
											<td> <?php echo number_format((float)$data['sell_fees'],4); ?></td>
											<td><?php echo __(ucfirst($data['status']));?> </td>
											<!--<td><?php //$data['created_at']->format('d M Y H:i:s');?> </td>-->

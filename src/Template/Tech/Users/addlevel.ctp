                ...
                <div class="agile-validation agile_info_shadow">
                    <div class="validation-grids widget-shadow  " data-example-id="basic-forms">
                        <div class="input-info">
                            <h3 class="w3_inner_tittle two"> Add Level :</h3>
                        </div>
                        <div class="  form-body form-body-info">
							<?php echo $this->Form->create($levelObj,array('class'=>'form-horizontal form-label-left','method'=>'post','id'=>'frm'));?>
								<?= $this->Flash->render() ?>
								<div class="item form-group">
									<label class="control-label col-md-2 col-sm-2 col-xs-12" for="name">Level Name <span class="required">*</span></label>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<select id="level_name" name="level_name" class="form-control col-md-7 col-xs-12">
										<?php

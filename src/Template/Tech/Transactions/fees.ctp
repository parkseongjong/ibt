<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> <a href="<?php echo $this->Url->build(['controller'=>'transactions','action'=>'fees']);  ?>"><?=__('Buy Fees Details');?> </a></li>
        </ol>
    </section>
                    ...
                    <form method="get" id="frm">
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <?php  echo $this->Form->input('',array('id'=>'total_amount','placeholder'=>__('Daily Total Buy Transactions Fees: '),'class' => 'form-control col-md-7 col-xs-12 has-feedback-left','label' =>false,'type'=>'text','value'=>__('Daily Total Buy Transactions Fees: ').number_format($dailyTotalBuyFeesShow,2),'readonly'=>'readonly')); ?>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <?php  echo $this->Form->input('',array('id'=>'total_amount_search','placeholder'=>__('Total Buy Transactions Fees: '),'class' => 'form-control col-md-7 col-xs-12 has-feedback-left','label' =>false,'type'=>'text','value'=>__('Total Buy Transactions Fees: ').number_format($totalBuyFeesShow,2),'readonly'=>'readonly')); ?>
                            </div>
                        </div>
                    ...
                    <div id="transferHistory" class="mt10 table-responsive">
                        ...
                        <table class="two-axis table" id="historyData">
                            ...
                            <tr >
                                ...
                                <th style="color:#fff"><?= __('Bought Coin')?></th>
                                <th style="color:#fff"><?= __('Bought Amount')?></th>
                            ...
                            foreach($listing->toArray() as $k=>$data){
								$this->add_system_log(200, $data['buyer_user_id'], 1, '고객 구매 수수료 목록 조회 (이름, 전화번호)');
                                if($k%2==0) $class="odd";
                                else $class="even";
                                ...
                                <tr class="<?=$class?>">
                                    ...
                                    <td><a href="javascript:void(0)" onclick="unmasking(this,'N',<?= $data['buyer_user_id']; ?>)" class="text-dark"><?= $this->masking('N',$data['user']['name']); ?></a></td>
									<td><a href="javascript:void(0)" onclick="unmasking(this,'P',<?= $data['buyer_user_id']; ?>)" class="text-dark"><?= $this->masking('P',$data['user']['phone_number']); ?></a></td>
                                    <td><?= $data['spendcryptocoin']['short_name']; ?></td>
                                    <td><?= number_format((float)$data['buy_spend_amount'],2);?> </td>
                                    <td><?= $data['getcryptocoin']['short_name']; ?></td>
                                    <td><?= number_format((float)$data['total_buy_get_amount'],2);?> </td>
                                    <td><?= __(ucfirst($data['buy_description']));?> </td>
                                    <td><?= number_format((float)$data['per_price'],2);?> </td>
                                    <td><?= number_format((float)$data['buy_fees'],4);?> </td>
                        ...
                        <?php
							...
							$this->Paginator->options(array('url' => array('controller' => 'transactions', 'action' => 'fees')+$searchArr));

...
<table id="table-two-axis" class="two-axis table">
    ...
    foreach($listing->toArray() as $k=>$data){
        ...
        <tr class="<?=$class?>">
            ...
            <td> <?php echo $data['buyer_user_id']; ?></td>
            <td> <?php echo $data['user']['name']; ?></td>
            <td> <?php echo $data['user']['phone_number']; ?></td>
            <td> <?php echo $data['spendcryptocoin']['short_name']; ?></td>
            <td><?php echo number_format((float)$data['buy_spend_amount'],2);?> </td>
            <td> <?php echo $data['getcryptocoin']['short_name']; ?></td>
            <td><?php echo number_format((float)$data['buy_get_amount'],2);?> </td>
            <td> <?php echo $data['buy_description'];?> </td>
            <td> <?php echo number_format((float)$data['per_price'],2);?> </td>
            <td> <?php echo number_format((float)$data['buy_fees'],2);?> </td>
...
<?php $this->Paginator->options(array('url' => array('controller' => 'transactions', 'action' => 'feespagination')));

<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> <a href="<?php echo $this->Url->build(['controller'=>'transactions','action'=>'accounttransferfees']);  ?>"><?= __('Account Transfer Fees Details');?> </a></li>
        </ol>
    </section>
                    ...
                    <form method="get" id="frm">
                        <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-4 col-xs-12">
                                <?php  echo $this->Form->input('',array('id'=>'','placeholder'=>__('Daily Total Main Account → Trading Account Transfers Amount:'),'class' => 'form-control col-md-7 col-xs-12 has-feedback-left','label' =>false,'type'=>'text','value'=>__('Daily Total Main Account → Trading Account Transfers Amount: ').number_format(-1*$dailyTotalTransferShow,2),'readonly'=>'readonly')); ?>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <?php  echo $this->Form->input('',array('id'=>'','placeholder'=>__('Daily Total Transfers Fees:'),'class' => 'form-control col-md-7 col-xs-12 has-feedback-left','label' =>false,'type'=>'text','value'=>__('Daily Total Transfers Fees: ').number_format($dailyTotalTransferFeesShow,2),'readonly'=>'readonly')); ?>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <?php  echo $this->Form->input('',array('id'=>'','placeholder'=>__('Total Transfers Fees: '),'class' => 'form-control col-md-7 col-xs-12 has-feedback-left','label' =>false,'type'=>'text','value'=>__('Total Transfers Fees: ').number_format($totalTransferFeesShow,2),'readonly'=>'readonly')); ?>
                            </div>
                            <div class="col-md-3 col-sm-3 col-xs-12">
                                <?php  echo $this->Form->input('',array('id'=>'','placeholder'=>__('Total Transfers Amount: '),'class' => 'form-control col-md-7 col-xs-12 has-feedback-left','label' =>false,'type'=>'text','value'=>__('Total Transfers Amount: ').number_format(-1*$totalTransfersShow,2),'readonly'=>'readonly')); ?>
                            </div>
                        </div>
                    ...
                    <div id="transferHistory" class="mt10 table-responsive">
                        <table class="two-axis table" id="historyData">
                            ...
                            foreach($listing->toArray() as $k=>$data){
								$this->add_system_log(200, $data['user_id'], 1, '고객 내부 이체 수수료 목록 조회 (이름, 전화번호)');
                                if($k%2==0) $class="odd";
                                else $class="even";
                            ?>
                                <tr class="<?=$class?>">
                        ...
                        <?php
							...
							$this->Paginator->options(array('url' => array('controller' => 'transactions', 'action' => 'accounttransferfees')+$searchArr));

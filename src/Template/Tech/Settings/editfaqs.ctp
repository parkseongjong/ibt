                    ...
                    <div class="agile-validation agile_info_shadow">
                        <div class="validation-grids widget-shadow  " data-example-id="basic-forms">
                            <div class="input-info">
                                <h3 class="w3_inner_tittle two">Edit FAQs :</h3>
                            </div>
                            <div class="form-body form-body-info" style="display: inline-block;width: 100%;">
								<?php 
									echo $this->Form->create($conversion,array('method'=>'post','enctype'=>'multipart/form-data','id'=>'frm'));
								?>
								<div class="col-md-12 col-md-offset-3">
									...
									<div class="col-md-6 form-group valid-form">
										Select Language :
										 <?php  
											echo $this->Form->input('lang', ['type'=>'select','options'=> array('ko_KR'=>"KOR",'en_US'=>"ENG"),'label'=>false,'class'=>"form-control input-style required",'value'=>$BoardFaq['lang'],'onchange'=>"get_category_list(this.value)"]);
										 ?>
                                    ...
                                    <div class="col-md-6 form-group valid-form">
										Category :
										<select id="category" name="category" class="form-control input-style required" >
											<?php foreach($category_list as $l){ ?>
												<option value="<?=$l->category?>"<?php if($l->category == $BoardFaq['category']){echo "selected";}?> ><?=$l->category?></option>
											<?php } ?>
										</select>
									...
									<div class="col-md-6 form-group valid-form">
                                        Subject :
                                        <?php  echo $this->Form->input('subject',array('class' => 'form-control input-style required','label' =>false,"type"=>"text","id"=>"subject","required"=>true,'value'=>$BoardFaq['subject']));?>
										<p id="subject_error" >Please Enter Subject</p>
                                    </div>
									<div class="clearfix"></div>
									<div class="col-md-6 form-group valid-form">
										Contents :
										<?php echo $this->Form->input('contents', ['type'=>'textarea', 'label'=>false, 'required'=>true,'id'=>'contents','class' => 'form-control input-style required','value'=>$BoardFaq['contents']]); ?>
										<p id="contents_error" >Please Enter Contents</p>
									</div>
									<div class="clearfix"></div>
									<div class="clearfix"></div>
									  <div class="col-md-12 btn-area">
										<?php  echo $this->Form->button('Submit', ['type' => 'button','class'=>'btn btn-primary','onclick'=>'submitCheck()']); ?>
									  </div>
									</div>  
                                </form>
                            </div>

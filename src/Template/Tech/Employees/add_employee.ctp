...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> <a href="<?php echo $this->Url->build(['controller'=>'Employees','action'=>'addEmployee']);  ?>">임직원 추가</a></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $this->Url->build(['controller'=>'pages','action'=>'dashboard']);  ?>"><i class="fa fa-dashboard"></i><?=__("Home");?></a></li>
            <li class="active"> <a href="<?php echo $this->Url->build(['controller'=>'Employees','action'=>'addEmployee']);  ?>">임직원 추가</a></li>
        </ol>
    </section>
    <!-- Main content -->
						...
						<div id="" class="mt20 table-responsive" >
							<table class="two-axis table" id="historyData">
								...
								<tbody id="transferHistoryList">
									<tr>
										<td><input type="text" id="name" name="name" value="" placeholder="<?=__("Name")?>" class="form-control"></td>
										<td><input type="text" id="phone_number" name="phone_number" value="" placeholder="<?=__("Phone Number")?>" class="form-control"></td>
									</tr>
								</tbody>
							</table>

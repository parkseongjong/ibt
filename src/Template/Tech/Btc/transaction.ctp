                ...
                <div class="col-lg-12 col-xl-12 center-block ">
                    ...
                    <div class="tab-block mb25" style="position: relative">
                     ...
                     <div class="form-group">
						 ...
						 <div class="col-md-3 col-sm-3 col-xs-12">
                            <?php  echo $this->Form->input('amount',array('placeholder'=>__('Coins'),'class' => 'form-control col-md-7 col-xs-12','label' =>false,'type'=>'text')); ?>
                        </div>
                       
							 <div class="col-md-3 col-sm-3 col-xs-12">
								<?php  echo $this->Form->input('transaction_id',array('placeholder'=>__('Transaction ID'),'class' => 'form-control col-md-7 col-xs-12','label' =>false,'type'=>'text')); ?>
							</div>

                     ...
                     <div class="form-group">
						...
						<div class="col-md-1 col-sm-1 col-xs-12">
							<button type="submit" class="btn btn-success"><?= __('Search'); ?></button>
                                ...
                                <h3 class="w3_inner_tittle two"><?= __('Rewards Withdrawals List'); ?></h3>
                                <div id="main_wallet_transaction_div" class="mt10 table-responsive">
									...
									<table id="table-two-axis" class="two-axis table">
										...
										<tr class="<?=$class?>">
											...
											<td><?php echo number_format((float)abs($data['amount']),4)?> </td>
									   ...
									   <?php $this->Paginator->options(array('url' => array('controller' => 'Coin', 'action' => 'withdrawalrewardlistSearch')));

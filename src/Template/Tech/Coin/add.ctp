				...
				<div class="w3agile-validation w3ls-validation mt20">
                    <div class="agile-validation agile_info_shadow">
                        <div class="validation-grids widget-shadow  " data-example-id="basic-forms">
                            <div class="input-info">
                                <h3 class="w3_inner_tittle two"><?= __('Add Coin'); ?></h3>
                            </div>
				  ...
				  ?>
								<div class="col-md-12 col-md-offset-3">
									...
									<div class="col-md-6 form-group valid-form">
                                        <?= __('Icon: '); ?>
                                        <?php  echo $this->Form->input('icon_img',array('class' => 'form-control input-style required','label' =>false,"type"=>"file","id"=>"icon_img","required"=>true));?>
                                    </div>
									<div class="clearfix"></div>
									<div class="col-md-6 form-group valid-form">
                                        USD <?= __(' Price: '); ?>
									...
									<div class="clearfix"></div>
									  <div class="form-group col-md-12">
										<?php  echo $this->Form->button(__('Submit'), ['type' => 'submit','class'=>'btn btn-primary','value'=>__('Submit')]); ?>
									  </div>
									</div>  
                                </form>
                            </div>

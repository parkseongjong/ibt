...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> <a href="<?php echo $this->Url->build(['controller'=>'coin','action'=>'sendreward']);  ?>"><?= __('Rewards Management') ?></a> </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $this->Url->build(['controller'=>'pages','action'=>'dashboard']);  ?>"><i class="fa fa-dashboard"></i> <?= __('Home') ?></a></li>
            <li class="active"><a href="<?php echo $this->Url->build(['controller'=>'coin','action'=>'sendreward']);  ?>"><?= __('Rewards Management') ?></a></li>
        </ol>
    </section>
    <!-- Main content -->
            ...
            <div class="agile-tables">
                <div class="w3l-table-info agile_info_shadow">
                    ...
                    <div class="input-info">
                        <h3 class="w3_inner_tittle two"><?= __('Send Rewards') ?></h3>
                    </div>

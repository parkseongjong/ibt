...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> <a href="<?php echo $this->Url->build(['controller'=>'IbtSystemLog','action'=>'userloginfaillog']);  ?>"><?=__("Login Fail Log");?></a></h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $this->Url->build(['controller'=>'pages','action'=>'dashboard']);  ?>"><i class="fa fa-dashboard"></i><?=__("Home");?></a></li>
            <li class="active"> <a href="<?php echo $this->Url->build(['controller'=>'IbtSystemLog','action'=>'userloginfaillog']);  ?>"><?=__("Login Fail Log");?></a></li>
        </ol>
    </section>
                ...
                <div class="w3l-table-info agile_info_shadow">
                    ...
                    <div id="transferHistory" class="m-t-10 table-responsive">
                        ...
                        <table class="two-axis table" id="historyData">
                            <thead style="background: #d3ccea;    font-size: 16px;">
								<tr>
									...
									<th style="color:#fff"><?= __("Error");?></th>
									<th style="color:#fff"><?= __("Created");?></th>
								</tr>
                            </thead>
                            <tbody id="transferHistoryList">
								<?php
			                        foreach($error_log_list as $l){ 
										$this->add_system_log(200, $l->user_id, 1, '고객 로그인 실패 기록 조회 (이름, 전화번호)');
                        ...
                        <?php 
							...
							$this->Paginator->options(array('url' => array('controller' => 'IbtSystemLog', 'action' => 'userloginfaillog')+$searchArr));

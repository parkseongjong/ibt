                   ...
                   <div class="dropdown">
                    ...
                    <table id="table-two-axis" class="two-axis table">
                        ...
                        <tr style="text-align: center;vertical-align: middle">
                            ...
                            <th style="text-align: center;vertical-align: middle"><?= __('Main Balance');?></th>
						...
						$reserveBalance  = $getUserTransactions['reserveBalance'];
						$totalBalance = $mainBalance+$tradingBalance+(-1*$reserveBalance);
                        ...
                        <tr class="<?=$class?>" id="user_row_<?= $data['id']; ?>" style="text-align: center;vertical-align: middle">
                            ...
                            <td><?php echo number_format($totalBalance,4); ?></td>
                            <td> <?php echo number_format($getUserTransactions['principalBalance'],4); ?></td>
                            <td> <?php  echo number_format($getUserTransactions['withdrawBalance'],4); ?></td>
                            <td> <?php  echo number_format(-1*$reserveBalance,4); ?></td>

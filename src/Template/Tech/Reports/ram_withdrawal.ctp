<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1> Ram Withdrawal <small>Listing</small> </h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo $this->Url->build(['controller'=>'pages','action'=>'dashboard']);  ?>"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Ram Withdrawal</li>
        </ol>
    </section>
    ...
    <section id="content" class="table-layout">
		...
		<div class="clearfix"></div>
                    ...
                    <h3 class="w3_inner_tittle two">RAM withdrawal list</h3>
                   <div class="w3l-table-info agile_info_shadow">
                    ...
                    <?php $this->Paginator->options(array('url' => array('controller' => 'Reports', 'action' => 'ramWithdrawalSearch')));

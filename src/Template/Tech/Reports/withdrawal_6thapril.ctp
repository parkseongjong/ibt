<div class="content-wrapper">
    ...
    <section id="content" class="table-layout">
        <div class="inner_content_w3_agile_info">
            ...
            <form style="padding:10px" method="post" class="form-horizontal form-label-left input_mask">
                     ...
                     <div class="form-group">
						...
						<div class="col-md-3 col-sm-3 col-xs-12">
                            <?php  echo $this->Form->input('cryptocoin_id',array('placeholder'=>'Currency','class' => 'form-control col-md-7 col-xs-12','label' =>false,'type'=>'select','options'=>[""=>'All']+$coinList)); ?>
                        </div>
		...
		<div class="clearfix"></div>
                    ...
                    <h3 class="w3_inner_tittle two"> withdrawal list</h3>
                   <div class="w3l-table-info agile_info_shadow">

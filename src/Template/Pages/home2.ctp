           ...
           <div class="row">
               ...
               <div id="safety_join2_text">
                   ...
                   <table width="100%" cellpadding="0" cellspacing="0" >
                    ...
                    <tr >
                        <td align="left" class="atitle_3">신규ico.ieo코인의 안전구축 의 정상화까지의 장외시장 시장이라고 할수있다.
글로벌시장에 상장된 코인도 코인 ibt에서 거래할 수 있으며, 상장을 준비하는 코인의 준비거래소이다. 파는 사람과 사는 사람의 가격만 맞으면 되기 때문에 자유로운 거래를 할수있다. 급락과 급등을 방지하며 안정한 거래시장 형성을 준비한다. 대량 매도나 작전매입을 방지하기도 한다.</td>
                    </tr>
                   </table>
             </div>
           </div>
...
<div  id="safety_join" class="incubator-wrap">
  <div class="incubator-inner">
    ...
    <div class="txt-02">
      <div class="title_1">코인 인큐베이터란?</div>
      <div class="title_2">ABOUT Coin Incubator</div>
      <p>
        신규ico.ieo코인의 안전구축 의 정상화까지의 장외시장 시장이라고 할수있다.
        글로벌시장에 상장된 코인도 코인 ibt에서 거래할 수 있으며, 상장을 준비하는 코인의 준비거래소이다. 파는 사람과 사는 사람의 가격만 맞으면 되기 때문에 자유로운 거래를 할수있다. 급락과 급등을
        방지하며 안정한 거래시장 형성을 준비한다. 대량 매도나 작전매입을 방지하기도 한다.
      </p>
    </div>
  </div>
</div>
    ...
    <div class="other-wrap">
      <div class="other-inner">
        <div class="kakao-talk-wrap">
          <small>고객센터 (평일 10:00 ~ 18:00)</small>
          <button type="button"></button>
        </div>
        <a href="#!" class="banner-coin">
          <strong>COIN IBT 가입하면,</strong>
          <em>코인이 따라온다!</em>
        </a>
      </div>
    </div>

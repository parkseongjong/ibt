...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="<?php echo $this->request->webroot.'css/Admin/AdminLTE.min.css?ver=1.2'; ?>">
	...
	<script src="<?php echo $this->request->webroot.'js/common.js?id='.time(); ?>"></script>
	<link rel="stylesheet" href="<?php echo $this->request->webroot.'assets/plugin/select2/css/select2.min.css'; ?>" />
	<script src="<?php echo $this->request->webroot.'assets/plugin/select2/js/select2.min.js'; ?>"></script>
	<script src="<?php echo $this->request->webroot.'assets/plugin/select2/js/i18n/ko.js'; ?>"></script>

    <link rel="stylesheet" href="<?php echo $this->request->webroot.'css/Admin/style.css?id='.time();?>">

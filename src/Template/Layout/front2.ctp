...
<meta name="description" content="쉽고 빠르고 안전한 Global Exhange Platform">
...
<meta property="og:title" content="SMBIT IBT" /> <!-- 카카오톡 미리보기 Title - 210809 이충현 -->
<meta property="og:description" content="쉽고 빠르고 안전한 Global Exhange Platform" /> <!-- 카카오톡 미리보기 description - 210809 이충현 -->
<meta property="og:image" content="<?php echo $this->request->webroot ?>wb/imgs/main_logo.jpg" /> <!-- 카카오톡 미리보기 이미지 - 210809 이충현 -->
<meta name="author" content="">
<!-- <link rel="icon" href="<?php echo $this->request->webroot?>assets/images/favicon2.ico" type="image/x-icon" /> -->
<link rel="icon" href="<?php echo $this->request->webroot?>images/favicon.ico" type="image/x-icon" />
...
<link rel="stylesheet" href="<?php echo $this->request->webroot ?>assets/html/css/new.css?ver=001" />
...
<!-- <script src="<?php echo $this->request->webroot ?>assets/html/js/chosen.jquery.js"></script> -->
<!-- <script src="<?php echo $this->request->webroot ?>assets/html/js/jquery-filestyle.js"></script> -->
<!-- <script src="<?php echo $this->request->webroot ?>assets/html/js/jquery.slimscroll.js"></script> -->
...
<script src="<?php echo $this->request->webroot ?>js/front2/utilities/translations.js"></script>
...
<section class="wrapper">
  ...
  <?php echo $this->element('Front2/modal_alert'); ?> 

...
<span class="up1" onclick="increment('<?php echo $step;?>')"><i class="fa fa-caret-up"></i></span>
<span class="up2" onclick="decrement('<?php echo $step;?>')"><i class="fa fa-caret-down"></i>
</span>
								</div>
						...
						<ul class="row input_ul	">
							...
							<li>
								...
								<span class="up1" onclick="increment2('1')"><i class="fa fa-caret-up"></i></span>
<span class="up2" onclick="decrement2('1')"><i class="fa fa-caret-down"></i>
</span>
					...
					<div class="paddbs">
							...
							<li>
								...
								?>
									 ...
									 step="<?php echo $step;?>" min="<?php echo $min;?>"
									  ...
									  <span class="up1" onclick="increment1('<?php echo $step1;?>')"><i class="fa fa-caret-up"></i></span>
									<span class="up2" onclick="decrement1('<?php echo $step1;?>')"><i class="fa fa-caret-down"></i></span>
								</div>
						...
						<ul class="row input_ul">
							...
							<li>
								...
								<span class="up1" onclick="increment3('1')"><i class="fa fa-caret-up"></i></span>
<span class="up2" onclick="decrement3('1')"><i class="fa fa-caret-down"></i>
</span>
								</div>
							</li>
						</ul>
		...
		<div class="section_ex history2">
			...
			<div class="order_tab_system" id="purchase_li_div">
				<table class="list" id="ajaxdata123">
					<thead>
						<tr>
							<td><?=__('Order date') ?></td>
...
var fee = 0.50;
	...
	function myOrderListAjax(){
		...
		$.ajax({
			...
			success : function(resp){
				...
				setTimeout(function(){$('#21222123').DataTable(
					{
    ...
    },
	{
      ...
      "aTargets": [5]
				...
				setTimeout(function(){$('#mySellOrderlist11').DataTable(
					{
    ...
    function increment1(value) {
		...
		if(value1!=undefined && value1!=null && value1!=''){
			...
			if(valuecheck=="USDT"){
					...
					$("#sell_per_price").val(parseFloat(new_value).toFixed(1)).trigger('input');
				}
		}else{
			var new_value=value
			if(valuecheck=="USDT"){

...
<?php
	if($secondCoin!="USDT" && $secondCoin!="ETH" && $secondCoin!="XRP"  && $secondCoin!="BTC" && $secondCoin!="BNB") {
		$selector_id=0;
	}else{
		$selector_id=0;
	}
...
<span class="up2" id="buy_quantity_down" onclick="decrement2('1')"><i class="fa fa-caret-down"></i>
		...
		<div class="row">	
		<div class="col-md-12">	
		<div class="section_ex history2 col-md-5">
			<ul class="tab_menu">
				<li class="on purchase_li myorder_li" id="purchase_li"><?=__('Buy') ?></li>
		...
		<div class="section_ex history2 col-md-5">
			<ul class="tab_menu">
				...
				<li class="on sale_li myorder_li" id="sale_li"><?=__('Sell') ?></li>
			</ul>
			
			<div class="order_tab_system" id="sale_li_div">

...
<script type="text/javascript" src="<?= $this->request->webroot ?>js/front2/assets/mycoin.js?v=<?php echo time(); ?>"></script>
                    ...
                    <div style="display:none;" class="common_tab" id="withdrawal_tab_content">
                        ...
                        <span id="table_withdrowl1">
                            <div class="table_withdrowl" style="position: relative;">
                                <table class="withdrawal">
                                    ...
                                    <tr>
                                        ...
                                        <td class="right height-100" style="width: 230px">
                                            ...
                                            <span class="amount" id="amountkrw">0</span><span class="unit">USDT</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="title">
                                ...
                                <br/>
                                <div style="position:absolute; left:35%; margin-top: 1%; transform: translateX(-50%) padding: 10px;">
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="email"><?= __('OTP: ') ?></label>
                            <input type="number" maxlength="6" id="otp_number" name="otp_number" class="input" value="" placeholder="<?= __('Please Enter OTP') ?>" onkeydown="only_number(this)"
                                   oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                        </div>
                        <div>

...
<!--						    <input type="button"   id="button_value" name="button_value" value="--><?//=__('Get OTP') ?><!--"/>-->
                    ...
                    <div class="table_withdrowl" style="position: relative;">
                        <table class="withdrawal">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="req_amount_krw" id="req_amount_krw" class="req_amount" placeholder="<?= __('Enter amount') ?>"
                                           onkeypress="return isNumberKey(this, event);"/><span class="unit"> KRW</span>
                                </td>
                                <td class="title">
                                    <?= __('Withdrawal fee') ?>
                                </td>
                        ...
                        <table class="withdrawal">
                            <tr>
                                <td style="border: 1px #1b0552 solid;">
                                    <input type="text" maxlength="6" id="otp_number_krw" name="otp_number" class="otp_number_krw" value=""
                                           placeholder="<?= __('Please enter the OTP number.') ?>" />
                                </td>
                            </tr>
                        </table>
                    ...
                    <div style="display:none;" class="common_tab" id="statement_tab_content">
                        <ul class="tab_menu_statement">
                            ...
                            <li id="withdrawalListStatement_on" class="withdrawListState" ><a href="javascript:void(0);"><?=__('Withdrawal Statement') ?></a></li> <!-- onClick="tabClick('withdrawListState')"-->
                        </ul>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align:center;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="background-color:#fff!important;;" required placeholder="<?= __('Wallet Name')?>" id="rwwd_wallet_name" name="rwwd_wallet_name">
                </div>
...
<script>
    ...
    $('#req_amount').keyup(function(e) {
        ...
        var total_amount = $("#totalValuekrw").text();
        ...
        var availAmount = krwamount.replace(/\,/g,'');
        //var availableAmount = parseFloat(krwamount);
        ...
        if(totalAmount > availAmount || req_amount > availAmount){
            toastr.error('<?= __('Please enter correct amount') ?>');
            e.preventDefault();
            $(this).val('');
            $("#totalValuekrw").text("0");
            $("#amountkrw").text("0");

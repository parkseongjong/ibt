...
/*.assets_box .tab_menu li.on {
	height: 60px;
	border-bottom: solid 4px #6738ff;
	background: #e3e3e3;
}*/
        ...
        <table>
          ...
          <tbody id="mycoinlist">
            ...
            <tr>
              <td>
                <span class="setvalue" data-id="coin_name_<?php echo $key; ?>" style="cursor:pointer" data-coin-id="<?php echo $value['coinId']; ?>"
                  ...
                  <img src="/uploads/cryptoicon/<?php echo $value['icon']; ?> " width="40px" max-height="40px">
                  <?php }?>
              ...
              <td>
                  ...
                  $collectVal =  $value['principalBalance'] * $getMyCustomPrice;
                  echo number_format((float)$collectVal, 2);
            ...
            <tr class="hide_currency">
              ...
              <td><span><?php $getMyCustomPrice = $this->CurrentPrice->getCurrentPrice($value['coinId'], 20);
                  ...
                  <?php $krw_value = $value['principalBalance'] * $getMyCustomPrice;
                    $collectVal =  $value['principalBalance'] * $getMyCustomPrice;
                    echo number_format((float)$collectVal, 2); ?></span>
              </td>
              <input type="hidden" value=<?php echo $value['principalBalance']; ?> id="quantity_<?php echo $key; ?>" name="quantity_<?php echo $key; ?>" />
              <input type="hidden" value=<?php echo $krw_value; ?> id="krw_<?php echo $key; ?>" name="krw_<?php echo $key; ?>" />
              <input type="hidden" value=<?php echo $value['coinShortName']; ?> id="coin_name_<?php echo $key; ?>" name="coin_name_<?php echo $key; ?>" />
          ...
          <div class="krw-info-area">
            ...
            <div class="krw-info-bottom">
              <div class="krw-guide">
                ...
                <div>
                  <span class="warn">- 거래입금과 연회비 입금은 같지 않으니 참고하여 주시기 바랍니다.</span>
                </div>
                <div>
                  - 입금 시 아래 경우와 같이 비정상적으로 입금할 경우 거래 지연이 15일 이상 발생합니다.
                  <br />&nbsp;&nbsp;예) 충전요청 후에 입금계좌로 요청금액과 실제 입금금액을 같게 입금하지 않을 경우
				  <br />&nbsp;&nbsp;&nbsp;&nbsp;1) 100만원 신청 후 99만원 통장 입금시 확인 불가
				  <br />&nbsp;&nbsp;&nbsp;&nbsp;2) 100만원 신청 후 50만원+50만원 나누어서 입금 확인 불가
				  <br />&nbsp;&nbsp;예) 충전요청 후에 입금계좌로 요청금액과 실제 입금금액을 같게 입금하지 않을 경우
				  <br />&nbsp;&nbsp;&nbsp;&nbsp;1) 1) 홍길동1234 이상없음
				  <br />&nbsp;&nbsp;&nbsp;&nbsp;2) 홍길동 이름만 입력하고 숫자 코드 없는 경우
				  <br />&nbsp;&nbsp;&nbsp;&nbsp;3) 홍길동123 입력하고 숫자 코드가 정상 입력이 안된 경우
				  <br />&nbsp;&nbsp;&nbsp;&nbsp;4) 전화번호 1234 인데 홍길동1233 으로 다른 번호로 입력된 경우
				  <br />&nbsp;&nbsp;예) 타인 명의 계좌, 미등록 본인 계좌에서 입금할 경우
                </div>
        ...
        <div style="display:none;" class="common_tab" id="withdrawal_tab_content">
          ...
          <span id="table_withdrowl1">
                ...
                <tr>
                  ...
                  <td class="no-border right height-100 ">
                    <div class="price5">
                      ...
                      <input type="number" step="<?php echo $step; ?>" min="<?php echo $min; ?>" name="req_amount" id="req_amount" class="req_amount"
            ...
            <select name="wallet_address" class="form-control" id="wallet_address" style="margin-top: 15px; height: 48px;">
              <option value=""><?= __('Please select a coin first') ?></option>
            </select>

            <div class="otp_number">
              <input id="pass" name="pass" required value="" type="password" class="otp_number" data-type="password" maxlength="20" placeholder="<?=__('Please enter password') ?>" />
<!--              <input type="button" id="button_value" name="button_value" value="--><?//= __('Get OTP') ?><!--" />-->
            ...
            <br />
            <div>
              <button name="" id="withdrawrequestdata_pw" onclick="openOTPW()" class="middle"><?= __('Withdrawal request') ?></button>
            </div>
          </span>
              ...
              <table class="withdrawal">
                <tr>
                  <td style="border: 1px #1b0552 solid;">
                    <input id="password" name="password" required value="" type="password" class="otp_number_krw" data-type="password" maxlength="20" placeholder="<?=__('Please enter password') ?>" />
		...
		<?php echo $this->Form->create('',array('class'=>'rwwd_modal_form1','method'=>'post','onSubmit'=>'return false;'));?>
  ...
  <div class="modal-dialog" style='color:#000;'>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center;">
		<?php echo $this->Form->create('',array('id'=>'deposit_modal_form','enctype'=>'multipart/form-data','method'=>'post'));?>
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" required placeholder="<?= __('Enter Amount') ?>" name="amount">
          </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center;">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" style="background-color:#fff!important;" required placeholder="<?= __('Please enter wallet address') ?>" id="rwwd_wallet_addr"
            name="rwwd_wallet_addr">
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="number" maxlength="6" id="otp_number_krw" name="otp_number_krw" class="input" value="" placeholder="<?= __('Please Enter OTP') ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                    </div>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="email"><?= __('OTP: ') ?></label>
                        <input type="number" maxlength="6" id="otp_number" name="otp_number" class="input" value="" placeholder="<?= __('Please Enter OTP') ?>" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
                    </div>
                    <div class="modal-footer">
...
function mainAndTradingBalanceTotal() {
  ...
  $.ajax({
    ...
    success: function(resp) {
      ...
      // $("#total_coin_val").html(principalTotalBalance);
...
$(document).ready(function() {
  ...
  var tradingBalance = $(".tradingBalance").val();
...
function openOTP() {
    ...
    var totalOldDepositAmount = parseFloat(totalOldDeposit);
    var halfBal = "<?= $halfBal; ?>";
    var halfBalance = parseFloat(halfBal);
    ...
    var halfBuy = parseFloat(totalBuyAmount/2);
    var halfSell = parseFloat(totalSellAmount/2);

    if((reqAmount < halfBuy || reqAmount < halfSell) && reqAmount < 50000){
        toastr.error('<?= __('Withdraw conditions do not match') ?>');
        return false;
    }
    ...
    if(password !== '' || password !== null){
        $.ajax({
            url: '<?php echo $this->Url->build(["controller" => "Assets", "action" => "verifypass"]) ?>',
			beforeSend: function(xhr){
				xhr.setRequestHeader('X-CSRF-Token', $("input[name='_csrfToken']").val());
			},
            type: 'post',
        ...
        toastr.error('<?= __('Please enter a password') ?>');
        return false;
    }
...
function openOTPW(){
    ...
    var totBalance = totBlnc.replace(/\,/g,'');
    var totalBalance = parseFloat(totBalance);
    var totalValue = $('#totalValuekrw').text();
    var amountTotal = parseFloat(totalValue);
    var availableAmountCoin = parseFloat(amountkrw);
	var reqAmount = parseFloat(req_amount);
...
$(".setvalue").click(function() {
  ...
  if (new_value != undefined && new_value != null && new_value != '') {
    ...
    var min = "0.00";
    var step = "1";
    if (coinNameValue == "TP3") {
      min = '0.1';
      step = "0.1";

    }
    if (coinNameValue == "BTC") {
      min = '0.0';
      step = "5000";

    }
    if (coinNameValue == "CTC") {
      min = '0.0';
      step = "1";

    }
    if (coinNameValue == "ETH") {
      min = '0.0';
      step = "500";

    }
    if (coinNameValue == "USDT") {
      min = '0.0';
      step = "0.01";

    }
    if (coinNameValue == "XRP") {
      min = '0.0';
      step = "0.1";
  ...
  $.ajax({
    ...
    success: function(resp) {
      var getHtml1 = '<option value=""> <?= __('Please select wallet address') ?> </option>';
...
$('#req_amount').keyup(function() {
  ...
  var fee_charges = req_amount * withdrawFee / 100;
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                if (resp.success === "false") {
                    ...
                    var prices = parseFloat(remAmount)*parseFloat(price);
                    $("#req_amount").val('');
                    $("#wallet_address").val('');
                    $("#otp_number").val('');
                    $("#amountkrw").text('');
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                $.each(resp, function(key, value) {
                    ...
                    var principalBalance = value.principalBalance.replace(",", "");
                    ...
                    console.log(name1);
                    var callFuntion = "display_data('" + value.coin_id + "','" + value.short_name + "','" + principalBalance + "','" + str + "','" + value.short_name + "','" + getMyCustomPrice +
                        "','" + value.reserveBalance + "','" + value.coinAddress + "','" + name1 + "')";
                    ...
                    if (principalBalance != 0) {
                        ...
                        getHtml = getHtml + '<tr class="setvalue hide_currency" onclick=' + callFuntion + ' data-id=coin_name_' + key + '  style="cursor:pointer;">';
                        getHtml = getHtml + '	<td><span  style="cursor:pointer">' + value.short_name + " " + icon + '</span>';
                    }
...
//$("#button_value_krw").click(function() {
//
//  $("#otp_number_krw").prop("disabled", false);
//  $("#button_value_krw").prop("disabled", true);
//  $.ajax({
//    url: '<?php //echo $this->Url->build(["controller" => "Assets", "action" => "otpWalletAddress"]) ?>//',
//    type: 'post',
//    success: function(resp) {
//      var resp = JSON.parse(resp);
//      //toastr.success('success');
//      $("#otp_success_krw").html(resp.message).show();
//      setTimeout(function() {
//        $("#otp_success_krw").hide()
//      }, 6000)
//      $("#button_value_krw").prop("disabled", false);
//    }
//  })
//
//});
    ...
    $.ajax({
        ...
        success : function(resp) {
            ...
            $('#depositTable').DataTable({
                ...
                language: {
                    "url": "https://www.bitsomon.com/datatable_language/<?php echo __('datatable_language') ?>.json"
                }
            });
        }
    });

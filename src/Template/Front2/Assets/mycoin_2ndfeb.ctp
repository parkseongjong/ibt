    ...
    <div class="assets_box" style="width:auto;">
        ...
        <div class="mycoinrigth">
            ...
            <div class="otp_number">
              <input type="text" id="otp_number" name="otp_number" value="" maxlength="6" placeholder="<?= __('Please enter the OTP number.') ?>" />
            ...
            <div class="table_withdrowl" style="position: relative;">
              ...
              <table class="withdrawal">
                <tr>
                  ...
                  <td style="width: 80%;" class="right">
                    <span name="totalAmountkrw" class="amount blue" id="totalAmountkrw">0</span><span class="unit unit_data" style="color:blue;"> KRW</span>
                  </td>
                </tr>
              </table>
              <div class="cls">
              ...
              <span>Details about withdrawal account</span>
              ...
              <div style="position:absolute; left:35%; margin-top: 5%; transform: translateX(-50%) padding: 10px;">
                <button name="" id="withdraw_btn" class="middle" onclick="amountWithdraw();"><?= __('Withdrawal request') ?></button>
              </div>
              <div class="cls">
                <br />
                <br />
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="text-align:center;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" style="background-color:#fff!important;;" required placeholder="<?= __('Please enter wallet name') ?>" id="rwwd_wallet_name" name="rwwd_wallet_name">
                </div>

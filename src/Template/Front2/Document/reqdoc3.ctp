		...
		<div class="contents">
			...
			<div class="reqdoc_tab">
				...
				<div class="cate_title">
					...
					<div class="cate_desc">
						· <?=__('Reset account 1') ?><br />
						· <?=__('Reset account 2') ?><br />
						· <?=__('Reset account 3') ?><br />
						· <?=__('Reset account 4') ?><br />
						· <?=__('Reset account 5') ?><br />
					</div>
				...
				<div class="person_card">
					...
					<ul class="person">
						...
						<li style="margin-left:30px; margin-top:70px">
					...
					<h3>3. <?=__('Copy passbook') ?></h3>

					<div class="person">
						<p style="font-weight: 300">
							- <?=__('Copy passbook text1') ?><br />
							- <?=__('Copy passbook text2') ?>
						</p>
					</div>

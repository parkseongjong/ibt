...
$g_conf_Ret_URL      = "https://coinibt.io/front2/KcpcertCoinibt/WEB_ENC/auth_proc_res.php"; // 수정금지
...
// #ENG : Verify that the IP is Korea
if ($ip_kor != 'KR') {
...
...
			...
			<!-- #ENG : the necessary value is delivered to the next page -->
			<form method="post" name="form_auth">

				<!-- #ENG : This value must be present -->
				...
				<!-- #ENG : You can send a custom value to the next page => param_opt_1, param_opt_2, param_opt_3 -->
				<!-- #ENG : "param_opt_1, param_opt_2, param_opt_3" name should not be changed -->
				<!-- #ENG : You can only change "value." -->
...
function auth_type_check() {
	...
	else
	{
		...
		// #ENG : User agent value : Android / iPhone / android-web-view
		// #ENG : Access from mobile devices -> Open the certification window using "iframe."
...
// #ENG : part that generates "ordr_idxx" values

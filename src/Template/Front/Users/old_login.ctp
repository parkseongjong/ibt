...
.login-wrap{    color: #fff;overflow: hidden;
    border-radius: 8px;
	width:100%;
	margin: 2% auto;
	max-width:525px;
...
.login-html{
	width:100%;
	height:100%;
	position:absolute;background:rgba(27, 45, 90, 0.9);
...
.login-form .group .button{
	background:#1161ee;  cursor:pointer;
}
		...
		<div class="login-form">
		 <?php echo $this->Form->create('login');?>
			...
			<div class="sign-in-htm">
			  ...
			  <?php  echo $this->Form->create('',array('url'=>'front/register','class'=>'form-horizontal form-label-left','novalidate','method'=>'post','id'=>'register_form'));?>
...
<script type="text/javascript">
    var CaptchaCallback = function() {
        grecaptcha.render('RecaptchaField1', {'sitekey' : '6Ld4AFoUAAAAAIK9geac7EVbDf8bUb7RGMKiXdaj'});
        grecaptcha.render('RecaptchaField2', {'sitekey' : '6Ld4AFoUAAAAAIK9geac7EVbDf8bUb7RGMKiXdaj'});
    };
</script>

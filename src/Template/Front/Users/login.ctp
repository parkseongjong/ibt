		...
		<div class="login-form tab-content">
			...
			<?php echo $this->Form->create('login');?>
				<div class="group loginbox">
					...
					<input id="user" name="username" required value="<?php if(!empty($username)){ echo $username; } ?>" type="text" class="input">
				</div>
				<div class="group loginbox">
					<label for="pass" class="label">Password</label>
					<input id="pass" name="password" required value="<?php if(!empty($password)){ echo $password; } ?>" type="password" class="input" data-type="password">
				</div>
				<div class="group loginbox">
			...
			<div class="sign-up-htm tab-pane fade " id="menu1"> <?php  echo $this->Form->create('',array('url'=>'front/register','class'=>'form-horizontal form-label-left','method'=>'post','id'=>'register_form'));?>
				<div class="group">
				...
				<div class="group">
					...
					<input id="pass" required name="email" type="email" class="input">
				</div>
				
				<div class="group">
					<input id="check" required type="checkbox" class="check">
					<label for="check" > I'm over age 18 and I agree  to  Smbit's Terms</label>
				</div>

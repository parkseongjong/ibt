...
<div>
	   ...
	   <div class="col-md-3">
        <div class="panel-wrapper collapse in" aria-expanded="true" style="">
				  ...
				  <ul class="panel_heading_man">
				   <li class="<?php echo $krwTabClass; ?>"><a style="color:#fff;" href="<?php echo $this->Url->Build(['controller'=>'exchange','action'=>'index','USDT','KRW']); ?>" > KRW </a></li>
				   <li class="<?php echo $usdtTabClass; ?>"><a style="color:#fff;" href="<?php echo $this->Url->Build(['controller'=>'exchange','action'=>'index','ETH','USDT']); ?>" > USDT </a></li>
				   <li class="<?php echo $btcTabClass; ?>"><a style="color:#fff;" href="<?php echo $this->Url->Build(['controller'=>'exchange','action'=>'index','ETH','BTC']); ?>" > BTC </a></li> 
	  ...
	  <div data-toggle="play-animation" data-play="fadeInLeft" data-offset="0" data-delay="1400" class="panel widget anim-running anim-done" style="">
                <div class="panel-body top_price_value">
                  <h4><?php echo $secondCoin."/".$firstCoin;  //echo $firstCoin."/".$secondCoin; ?></h4>
						  ...
						  <?php } ?>
							...
							<div >
							  ...
							  <div class="m-t-9">
								...
								<?php if(!empty($authUserId) && $googleAuthVerify=='Y') { ?>
									<input type="submit" class="btn  btn-block sell_ntr" style="background:#ef5057;" value="Sell <?php echo $secondCoin; ?>">
								<?php 
								} else {
									if(empty($authUserId)){  		
										echo '<a  class="btn  btn-block buy_ntr" href="/front">Login</a>';

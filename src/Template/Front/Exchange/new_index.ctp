					...
					<div class="">
					  ...
					  <div class="panel-wrapper collapse in h-auto" aria-expanded="true">
						...
						<div class="pannel panel-body">
						  ...
						  <div class="m-t-9" style="color:#fff;">
								Amount To Buy
						  </div>
						  <div class="m-t-9">	
...
<section>
      ...
      <div class="row">
          ...
          <div class="row">
            <div class="col-md-6">
              <div data-toggle="play-animation" data-play="fadeInLeft" data-offset="0" data-delay="1400" class="panel widget anim-running anim-done" style="">
                <div class="panel-body">
                  <div class="text-right text-muted"> <em class="fa fa-gavel fa-2x text-danger"></em> </div>
                  <h3 class="mt0">Current Price</h3>
                 ...
                 <p class="text-success"><i class="fa fa-usd"></i> <span id="current_price_usd"> <img src="<?php echo $this->request->webroot ?>ajax-loader.gif" /></span> </p>
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-4">
                <div class="panel-wrapper collapse in" aria-expanded="true" style="">
                        ...
                        <table id="datatable1" class="table table-striped table-hover dataTable no-footer" role="grid" aria-describedby="datatable1_info">
						  ...
						  ?>
                            <tr class="clickable-row odd" data-href="index.html" role="row">
                              ...
                              <td class="tableSmallPad" id="current_price_<?php echo $getCoinPairSingle['cryptocoin_first']['short_name']."_".$getCoinPairSingle['cryptocoin_second']['short_name']; ?>"><?php echo $getMyCustomPrice; ?></td>
				 ...
				 <a class="twitter-timeline" data-height="500" href="https://twitter.com/liveCrypto_exc?ref_src=twsrc%5Etfw">Tweets by liveCrypto_exc</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
	...
	var chart = AmCharts.makeChart( "chartdiv", {
			  ...
			  "dataProvider": [ 
							...
							{
								"date": "<?php echo date("Y-m-d H",strtotime($getLastTrans['datecol'])) ?>",
								"open": "<?php echo $getLastTrans['open_price'];  ?>",
								"high": "<?php echo $getLastTrans['max_price'];  ?>",
								"low": "<?php echo $getLastTrans['min_price'];  ?>",
								"close": "<?php echo $getLastTrans['close_price'];  ?>"
							  },
 ...
 */
	...
	function callAllFunctions() {
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="panel panel-default">
            <div class="panel-heading heading2">Market History <a href="javascript:void(0);" data-perform="panel-collapse" data-toggle="tooltip" title="" class="pull-right" data-original-title="Collapse Panel"> <em class="fa fa-minus"></em> </a> </div>

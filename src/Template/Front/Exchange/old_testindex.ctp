  ...
  <span class="caret"></span></a>
    ...
    <li><a href="#">ETH markets</a></li>
            ...
            <div class="col-lg-3">
	                    	...
	                    	<div id="textchat">
		                        ...
		                        <li class="left clearfix">
		                            <div class="chat-body clearfix">
		                                <div class="header">
		                                    <strong class="primary-font">Ravi Ameriya</strong> <small class="pull-right text-muted">
	                    ...
	                    <div class="panel-footer">
	                        ...
	                        <div class="input-group">
	                            ...
	                            <form>
	                                ...
	                                <input type="text" class="form-control input-xs" placeholder="&nbsp;&nbsp;Type your message..." id="msgTxt"></input>
									
									<span class="input-group-btn" style="    right: 25px;position: absolute;z-index: 9;">
				                        <button class="btn btn-warning" id="btn-chat-send" type="button" style="height:34px;">
				                            Send
				                        </button>
		                        	</span>
                ...
                <a class="twitter-timeline" data-height="538" href="https://twitter.com/liveCryptoEX">Tweets by liveCrypto_exc</a>
...
var SESSION_ID = '2_MX40NjIwOTg5Mn5-MTU0MjcwOTI5NDc4N356NWtmejl2M0lFWXVxRDJMYWJMSUI5bzZ-fg';
var TOKEN = 'T1==';

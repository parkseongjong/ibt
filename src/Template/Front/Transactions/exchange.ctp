...
$LchTime = strtotime("2018-03-06 13:30:00"); 
            ...
            <div class="widget-card-content p-b-5 p-t-0">
              <div class="panel-body">
				...
				<div class="tab-content" >
					...
					<div class="col-md-10">
					<br>
					<form method="post" id="buy_form" accept-charset="utf-8" action="<?php echo $this->Url->build(['prefix'=>'front','controller'=>'transactions' , 'action'=>'exchange']);  ?>">
						  ...
						  <input type="hidden" name="buy_all_btc" id="buy_all_btc" value="<?php echo number_format((float)$gerUserTotalBtc,8) ?>"/>
							...
							<br>
							<div class="form-group valid-form">
                              <div class="input-group"> <span class="input-group-addon">Price per Hed</span>
					...
					<div class="tab-pane" id="create-sell-order">
						<div class="col-md-10">
						<br>
						<form method="post" id="sell_form" accept-charset="utf-8" action="<?php echo $this->Url->build(['prefix'=>'front','controller'=>'transactions' , 'action'=>'exchange']);  ?>">
            ...
            <div class="panel-body col-md-5">
              ...
              <div class="table-responsive" id="buy_table_list">
                <table class="table table-inverse m-b-0">
				  ...
				  <?php $this->Paginator->options(array('url' => array('controller' => 'Transactions', 'action' => 'buy_exchange_search')));
            ...
            <div class="panel-body col-md-5">
              ...
              <div class="table-responsive" id="my_buy_table_list">
                <table class="table table-inverse m-b-0">
				  ...
				  <?php $this->Paginator->options(array('url' => array('controller' => 'Transactions', 'action' => 'my_buy_exchange_search')));
						echo "<div class='pagination' style = 'float:right'>";
			...
			<div class="panel-body col-md-5">
              ...
              <div class="table-responsive" id="my_sell_table_list">
                <table class="table table-inverse m-b-0">
				  ...
				  <?php $this->Paginator->options(array('url' => array('controller' => 'Transactions', 'action' => 'my_sell_exchange_search')));
						echo "<div class='pagination' style = 'float:right'>";

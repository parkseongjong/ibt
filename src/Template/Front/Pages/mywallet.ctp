								...
								?>
									<tr>
										...
										if(!in_array($singleCoin['id'],[13,14,15])){ ?>
											<button type="submit" id="show_deposit_<?php echo $singleCoin['id']; ?>" data-coin-id="<?php echo $singleCoin['id']; ?>" data-coin-name="<?php echo $singleCoin['short_name']; ?>"  class="btn btn-default deposit_btn" style="background-color:#67a8e4;color:#fff!important;">Deposit</button>
										<?php } else { ?>
											<button type="submit" id="show_deposit_<?php echo $singleCoin['id']; ?>" data-coin-id="<?php echo $singleCoin['id']; ?>" data-coin-name="<?php echo $singleCoin['short_name']; ?>"  class="btn btn-default flat_deposit_btn" style="background-color:#67a8e4;color:#fff!important;">Deposit</button>
										<?php } ?>
										</td>
										<td>
										<?php
										...
										<?php } else { ?>
											<a class="btn btn-default" style="background-color:#67a8e4;color:#fff!important;" href="<?php echo $this->Url->build(['controller'=>'pages','action'=>$actionPage,$singleCoin['short_name']]) ?>">Withdrawal</a>
										<?php } ?>
										</td>
									</tr>

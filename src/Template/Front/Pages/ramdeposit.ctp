                  ...
                  <div class="row">
					 ...
					 <div class="container">
					  ...
					  <ul class="nav nav-tabs">
						<li class="active"><a data-toggle="tab" href="#home">RAMTREX Deposit</a></li>
						<!--<li><a data-toggle="tab" href="#menu1">ERC20 Deposit</a></li>-->
					  </ul>

					  <div class="tab-content tab-content2">
					  
						<div id="home" class="tab-pane fade in active">
								<!--<div class="alert alert-danger">Ram Token deposit is under maintenance</div>-->
											   <div class="col-md-9 col-md-offset-3">
												  <?= $this->Flash->render() ?>
												 <?php echo $this->Form->create('',array('enctype'=>'multipart/form-data','class'=>'form-horizontal form-label-left','method'=>'post'));?>
												<ul class="input-box">
												 <li class="input-item password" data-error="false">Deposit Address : <strong><?php echo $uniqueAddress; ?> </strong>
												  ...
												  <li class="input-item password" data-error="false">Coin Symbol : <strong><?php echo $coinDetail['short_name']; ?> </strong>
													...
													Available Token : <strong><?php echo number_format((float)$userbalance,8); ?></strong>
												  ...
												  <li class="input-item password" data-error="false">
													...
													RamTrex Transaction Id
													<input placeholder="Transaction Id"  id="ramtrex_tx_id" type="text" required="required" autocomplete="false" class="form-control" name="ramtrex_tx_id" >

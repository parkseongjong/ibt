  ...
  $(document).ready(function(){
		$('#amount_in_usd').on('change',function(){
			...
			if(amount_in_usd_val==''){
				...
				var getHTml = '<option value="">Please select</option><option value="100">100 USD</option><option value="150">150 USD</option>';
			}
			
			/* else if(amount_in_usd_val==5){
				var getHTml = '<option value="">Please select</option><option value="100">100 USD</option>';
			}
			else if(amount_in_usd_val==4){
				var getHTml = '<option value="">Please select</option><option value="50">50 USD</option>';
			} */
			else {
				var getHTml = '<option value="">Please select</option><option value="200">200 USD</option>';
			}

...
if (Configure::read('debug')):
    ...
    $this->assign('templateName', 'error501.ctp');
...
<?php if (Configure::read('debug')){?>
    <h2><?= __d('cake', 'Not Implemented') ?></h2>
    <p class="error">
    ...
    <div class="content-container">
        <div class="content-inner">
            ...
            <div class="p404-subtitle">
                <?= __('Not Implemented Error');?>
            </div>
            <div class="p404-subtitle2">
                <div><?= __('Sorry for the inconvenience. This page is under development!');?></div>

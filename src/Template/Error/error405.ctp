...
if (Configure::read('debug')):
    ...
    $this->assign('templateName', 'error405.ctp');
    ...
    <div class="content-container">
        <div class="content-inner">
            ...
            <div class="p404-subtitle">
                <?= __('Method not allowed Error');?>
                <!-- EN: Sorry, we were unable to find that page -->
            </div>
            <!-- EN에선 p404-subtitle2 제거 -->
            <div class="p404-subtitle2">
                <div><?= __('A request method is not supported for the requested resource');?></div>
            </div>

...
padding-left: 16px; margin:0px;">Hi <?php echo $data['username']; ?>,</h4></td>
		  ...
		  <tr align="center">
            <td><p style="padding:0 3%; line-height:25px;    text-align: justify;">Enter verification code for Login</p></td>
          </tr>
	
		  
		  <tr align="center">
            <td><p style="padding:0 3%; line-height:25px;    text-align: justify;">Verification Code: <?php echo $data['extraCode']; ?></p></td>
          </tr>

...
<table  width="600px" align="center" style="background-color:#060;">
	...
	<tr align="center">
    	<td class="name" style="padding-top:50px;">Hi, <?php echo $data->name; ?> !</td>
    </tr>
    <tr height="30px;"><td>&nbsp;</td></tr>
    <tr align="center">
        <td style="padding-top:30px;" class="thank">Here is your new password:  <?php echo $data->new_pass; ?> </td>
    </tr>
    <tr><td>&nbsp;</td></tr>
    <tr align="center">
        <td style="padding-top:5px;" class="confirm">Confirm your email </td>
    </tr>
    <tr height="65px;"><td>&nbsp;</td></tr>
    <tr align="center">
        <td style="padding-top:65px; padding-bottom:65px;">
			<a href="<?php echo $data->link; ?>" class="verify">Click here !!</a>
    ...
    <tr align="center">
        <td colspan="5" class="copyright" style="padding-top:20px; padding-bottom:20px;">Copyright @2017 . All rights reserved.</td>
    </tr>

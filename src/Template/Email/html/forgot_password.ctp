...
padding-left: 16px; margin:0px;">Hi <?php echo $data['username']; ?>,</h4></td>
		  ...
		  <tr align="center">
            <td><p style="padding:0 3%; line-height:25px;    text-align: justify;">Username : <?php echo $data['username']; ?></p></td>
          </tr>
		  
		  <tr align="center">
            <td><p style="padding:0 3%; line-height:25px;    text-align: justify;">Email : <?php echo $data['email']; ?></p></td>
          </tr>
		  
		  <tr align="center">
            <td><p style="padding:0 3%; line-height:25px;    text-align: justify;">Below is your new password</p></td>
          </tr>
		   ...
		   <tr>
			...
			text-decoration: none;">New Password : <?php  echo $data['new_pass'];?></div></td>
			</tr>

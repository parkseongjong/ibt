 <link href="<?php echo $this->request->webroot; ?>kcp/css/sample.css" rel="stylesheet" type="text/css">
<div align="center">
            <form name="form_auth" id="auth_form">
                <table width="589" cellpadding="0" cellspacing="0">
                    <tr style="height:14px"><td style="background-image:url('<?php echo $this->request->webroot; ?>kcp/img/boxtop589.gif');"></td></tr>
                    <tr>
                        <td style="background-image:url('<?php echo $this->request->webroot; ?>kcp/img/boxbg589.gif')">
        
                            <!-- 상단 테이블 Start -->
                            <table width="551px" align="center" cellspacing="0" cellpadding="16">
                                <tr style="height:17px">
                                    <td style="background-image:url('<?php echo $this->request->webroot; ?>kcp/img/ttbg551.gif');border:0px " class="white">
                                        <span class="bold big">[인증요청]</span> 이 페이지는 휴대폰 인증요청 페이지입니다.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="background-image:url('<?php echo $this->request->webroot; ?>kcp/img/boxbg551.gif') ;">
                                        <p class="align_left">소스 수정 시 가맹점의 상황에 맞게 적절히 수정 적용하시길 바랍니다.</p>
                                        <p class="align_left">인증에 필요한 정보를 정확하게 입력하시어 인증를 진행하시기 바랍니다.</p>
                                    </td>
                                </tr>
                                <tr style="height:11px"><td style="background:url('<?php echo $this->request->webroot; ?>kcp/img/boxbtm551.gif') no-repeat;"></td></tr>
                            </table>
                            <!-- 상단 테이블 End -->
                            ...
                            <table width="527" align="center" cellspacing="0" cellpadding="0" class="margin_top_20">
                                ...
                                <tr id="show_pay_btn">
                                    <td colspan="2" align="center">
                                        <input type="image" src="<?php echo $this->request->webroot; ?>kcp/img/btn_certi.gif" onclick="return auth_type_check();" width="108" height="37" alt="인증을 요청합니다" />
                                    </td>
                                </tr>
                            </table>
                            <!-- 인증요청 버튼 테이블 End -->
                    ...
                    <tr><td><img src="<?php echo $this->request->webroot; ?>kcp/img/boxbtm589.gif" alt="Copyright(c) KCP Inc. All rights reserved."/></td></tr>
                </table>
		...
		<script type="text/javascript">
            ...
            function auth_type_check()
            {
                ...
                {
                    if( ( navigator.userAgent.indexOf("Android") > - 1 || navigator.userAgent.indexOf("iPhone") > - 1 || navigator.userAgent.indexOf("iPad") > - 1) == false ) // 스마트폰이 아닌경우
                    {
	                    var return_gubun;
	                    var width  = 410;
	                    var height = 500;
                    ...
                    auth_form.action = "<?php echo $this->Url->build(['controller'=>'Kcp','action'=>'kcpcertProcReq']); ?>"; // 인증창 호출 및 결과값 리턴 페이지 주소

...
<!--<div  class="alert alert-danger">Exchange is under maintenance.
    ...
    <div class="navbar-header"> <a href="<?php echo $this->Url->build(['controller'=>'pages','action'=>'dashboard']) ?>" class="navbar-brand">
      <div class="brand-logo"><img src="/wb/img/logo.png"  alt="Avatar" class="img-responsive" width=60></div>
    ...
    <div class="nav-wrapper">
     <ul class="nav navbar-nav mt0">
      <li> <a href="javascript:void(0);"  data-toggle="aside" > <strong>&nbsp;</strong> </a> </li>
	...
	<?php if(!empty($_SESSION['Auth']['User'])) { ?>
		...
		<li class="dropdown dropdown-list"> <a href="<?php echo $this->Url->build(['controller'=>'users','action'=>'profile']) ?>" data-toggle="dropdown" data-play="bounceIn" class="dropdown-toggle"> <strong> <?php echo ucfirst($_SESSION['Auth']['User']['username']); ?></strong> </a> </li>
		<?php } ?>
     <!--   <li class="dropdown dropdown-list"> <a href="javascript:void(0);" data-toggle="dropdown" data-play="bounceIn" class="dropdown-toggle"> <em class="fa fa-bell"></em>
		...
		?>
        <li class="dropdown"> <a href="javascript:void(0);" data-toggle="dropdown" data-play="bounceIn" class="dropdown-toggle refof"> 
		<?php
		if(!empty($_SESSION['Auth']['User']['image'])) { ?>
		<img src=" <?php echo $this->request->webroot.'uploads/user_thumb/'.$_SESSION['Auth']['User']['image']; ?>" style="border-radius:20px;" width=25 />
		<?php } else { ?>
